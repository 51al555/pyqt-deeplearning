...
# Form implementation generated from reading ui file 'UI_regressor.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.bn_load_model = QtWidgets.QPushButton(self.groupBox_2)
        self.bn_load_model.setObjectName("bn_load_model")
        self.verticalLayout_3.addWidget(self.bn_load_model)
        self.bn_predict = QtWidgets.QPushButton(self.groupBox_2)
        ...
        self.gridLayout_4.addWidget(self.bn_train, 0, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.bn_saveWeight, 0, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.bn_continue_train, 0, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_2.setTitle(_translate("Form", "回归器"))
        self.bn_load_model.setText(_translate("Form", "加载模型"))
